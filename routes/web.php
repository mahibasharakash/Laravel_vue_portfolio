...
Route::get('/blog_template', [AppController::class, 'blog_system'])->where('any', '.*')->name('lvs.blog.system');
Route::get('/blog_template/{any}', [AppController::class, 'blog_system'])->where('any', '.*')->name('lvs.blog.system.any');

Route::get('/ecommerce_template', [AppController::class, 'ecommerce_system'])->where('any', '.*')->name('lvs.ecommerce.system');
Route::get('/ecommerce_template/{any}', [AppController::class, 'ecommerce_system'])->where('any', '.*')->name('lvs.ecommerce.system.any');

Route::get('/learning_management_template', [AppController::class, 'learning_management_system'])->where('any', '.*')->name('lvs.learning.management.system');
...
Route::get('/chat_application_template', [AppController::class, 'chat_application_system'])->where('any', '.*')->name('lvs.chat.application.system');
...
Route::get('/hospital_template', [AppController::class, 'hospital_system'])->where('any', '.*')->name('lvs.hospital.system');
Route::get('/hospital_template/{any}', [AppController::class, 'hospital_system'])->where('any', '.*')->name('lvs.hospital.system.any');

Route::get('', [AppController::class, 'portfolio_system'])->where('any', '.*')->name('lvs.portfolio.system');
